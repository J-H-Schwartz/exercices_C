...
#define BLINK_DELAY_PLAY_TOKEN 250 //mseconds
#define BLINK_COUNT_PLAY_TOKEN 1
#define BLINK_DELAY_VICTORY_TOKENS 500 //mseconds
#define BLINK_COUNT_VICTORY_TOKENS 15
#define BLINK_DELAY_VICTORY_W 500 //mseconds
...
#define IDLE_DELAY 500 //mseconds
