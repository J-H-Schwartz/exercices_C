...
#define BLINK_DELAY_PLAY_TOKEN 250000 //µseconds
#define BLINK_COUNT_PLAY_TOKEN 1
#define BLINK_DELAY_VICTORY_TOKENS 500000 //µseconds
#define BLINK_COUNT_VICTORY_TOKENS 15
#define BLINK_DELAY_VICTORY_W 500000 //µseconds
...
#define IDLE_DELAY 500000 //µseconds
